...
def make_train(config):
    ...
    if config["ENV_NAME"] == "TabularMDP":
        ...
        # We get the default params, then replace reward_scale with our config's value
    ...
    # Optionally wrap the environment:
    # (FlattenObservationWrapper is optional. For screen observations in TabularEnv,
...
if __name__ == "__main__":
    ...
    config = {
        ...
        # NEW: if the spreadsheet says you need to scale rewards by factor 0.1
        # you can set this to 0.1. Or if you need to multiply by 10, set 10.0, etc.
        "REWARD_SCALE": 1,
    ...
    # Convert entire metrics pytree to host arrays:
    metrics = jax.device_get(out["metrics"])

    # If the LogWrapper tracked "returned_episode_returns", we can log them:
